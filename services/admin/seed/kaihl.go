...
func seedKailh(tx *gorm.DB, admin models.User) error {
	kailhSwitches := []models.Switch{
		{
			Name:             "BOX Navy",
			...
			Details: models.Details{
				...
				BottomOutForcePoint:   ptr(float32(3.6)),
		...
		},
		{
			...
			Details: models.Details{
				SpringForce:           ptr(float32(50)),
				ActuationPoint:        ptr(float32(1.6)),
				BottomOutForce:        ptr(float32(60)),
				BottomOutForcePoint:   ptr(float32(3.6)),
				TotalTravel:           ptr(float32(3.6)),
				PreTravel:             ptr(float32(1.6)),
				FactoryLubed:          false,
				StemMaterialID:        ptr(22), // ABS
				TopHousingMaterialID:  ptr(26), // Polycarbonate
				BaseHousingMaterialID: ptr(24), // Nylon
		...
		},
		{
			...
			Details: models.Details{
				...
				BottomOutForce:        ptr(float32(60)),
				BottomOutForcePoint:   ptr(float32(3.5)),
		...
		},
		{
			...
			Details: models.Details{
				SpringForce:           ptr(float32(50)),
				ActuationPoint:        ptr(float32(1.7)),
				BottomOutForce:        ptr(float32(60)),
				BottomOutForcePoint:   ptr(float32(3.6)),
				TotalTravel:           ptr(float32(3.6)),
				PreTravel:             ptr(float32(1.7)),
				FactoryLubed:          false,
				StemMaterialID:        ptr(22), // ABS
				TopHousingMaterialID:  ptr(26), // Polycarbonate
				BaseHousingMaterialID: ptr(24), // Nylon
		...
		},
		{
			...
			Details: models.Details{
				...
				PreTravel:             ptr(float32(2.0)),
				FactoryLubed:          false,
				StemMaterialID:        ptr(25), // UHMWPE
				TopHousingMaterialID:  ptr(25), // UHMWPE
				BaseHousingMaterialID: ptr(25), // UHMWPE
				SpringMaterialTypeID:  ptr(17), // Steel
		...
		{
			Name:             "Midnight Pro Silent Brown",
		...
		{
			Name:             "Midnight Pro Silent Black",
	...
	err := processSwitches(tx, kailhSwitches, admin)
	if err != nil {
		return err
	}
